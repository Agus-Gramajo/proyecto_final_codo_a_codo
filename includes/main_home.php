      ...
      <div class="container">
        ...
        <div class="row mt-5">
          ...
          <div class="col-lg-4" data-aos="fade-right">
            <div class="info">
              <a href="https://goo.gl/maps/biRtyv2dm2YiWHDP6" target="_blank">
              <div class="address">
              ...
              <a href="mailto:agus.gramajodw@gmail.com">
              <div class="email">
              ...
              <a href="https://api.whatsapp.com/send?phone=5491159104084" target="_blank">
              <div class="phone">
          ...
          <div class="col-lg-8 mt-5 mt-lg-0" data-aos="fade-left">
            ...
            <form action="./admin/actions/contact.php" method="post" role="form" class="form-group php-email-form">
              <div class="row">
                <div class="col-md-6 form-group">
                  <input type="text" name="cont_name" class="form-control" id="cont_name" placeholder="Tu nombre" required>
                </div>
                <div class="col-md-6 form-group mt-3 mt-md-0">
                  <input type="email" class="form-control" name="cont_mail" id="cont_mail" placeholder="Email" required>
                </div>
              </div>
              <div class="form-group mt-3">
                <input type="text" class="form-control" name="cont_subject" id="cont_subject" placeholder="Asunto" required>
              </div>
              <div class="form-group mt-3">
                <textarea class="form-control" name="cont_msg" rows="5" placeholder="Mensaje" required></textarea>
              </div>
              <div class="my-3">
                <span class="alert-<?php echo $_SESSION['estilo']?>"><?php echo $_SESSION['mensaje']?></span>
              </div>
              <div class="text-center"><button type="submit" name="send_msg">Enviar mensaje</button></div>
            </form>
