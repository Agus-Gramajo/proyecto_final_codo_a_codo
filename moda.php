      ...
      <div class="container">
        ...
        <ul id="portfolio-flters" class="d-flex justify-content-end" data-aos="fade-up">
          ...
          <?php 
              ...
              $query = "SELECT subcategorias.subcat_name FROM categorias INNER JOIN subcategorias ON categorias.categoria_id = subcategorias.categoria_id WHERE categorias.cat_name = 'moda'";
        ...
        <?php 
              ...
              $query = "SELECT * FROM emprendedores INNER JOIN categorias ON emprendedores.categoria_id = categorias.categoria_id WHERE emprendedores.emp_publicar = 1 AND categorias.cat_name = 'moda'";
